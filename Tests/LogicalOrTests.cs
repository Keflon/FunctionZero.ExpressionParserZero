...
{
    [TestClass]
    public class LogicalOrTests : INotifyPropertyChanged
    {
        private int _intA;
        private int _intB;
        private LogicalOrTests _myObject;
        ...
        public LogicalOrTests MyObject
        {
            get => _myObject;
        ...
        public void TestExpression0()
        {
            ...
            Assert.AreEqual(5 > 6 || 6 > 7, (bool)binding.Result);
        }
        ...
        public void TestExpression1()
        {
            ...
            Assert.AreEqual(5 > 6 || 6 > 5, (bool)binding.Result);
        }
        ...
        public void TestExpression2()
        {
            ...
            Assert.AreEqual(6 > 5 || 7 > 8, (bool)binding.Result);
        }
        ...
        public void TestExpression3()
        {
            ...
            Assert.AreEqual(6 > 5 || 8 > 7, (bool)binding.Result);
        }
        ...
        public void TestExpression4()
        {
            ...
            Assert.AreEqual(IntA > IntB || IntB > IntA, (bool)binding.Result);
        }
        [TestMethod]
        ...
        public void TestExpression6()
        {
            ...
            try
            {
                var binding = new ExpressionBind(this, "(True && False) || (SomethingHorrid)");
